        ...
        <div class="mt-6 mb-10 md:ml-150">
            <div class="flex flex-row space-x-10">        
                <a href="https://www.instagram.com/openbeetracker" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-instagram text-black h-10 w-10 dark:text-white" viewBox="0 0 16 16">
                    ...
                    <!--<img v-if="isDark" src="../assets\images/instagram.png" class="h-12 w-12">
                    <img v-else src="../assets\images/iconmonstr-instagram-11.svg" class="h-12 w-12">-->
                </a>
                <a href="https://www.youtube.com/channel/UCApS3abjBtJ1s1E4VZDBLag" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-youtube text-black w-10 h-10 dark:text-white" viewBox="0 0 16 16">
