    ...
    <footer class="w-full transition-colors duration-100 bg-white dark:bg-true-gray-900" >
        ...
        <div class="w-full bg-gray-100 p-3 flex justify-between">
            ...
            <div class="flex space-x-5">
                <span class="text-gray-400 text-sm">Ci trovi su</span>
                <a href="https://www.instagram.com/openbeetracker/" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="h-5 w-5 text-gray-400 hover:text-bee transition-colors" viewBox="0 0 16 16">
