<template>
  <div class="mt-5 mx-auto max-w-7xl px-4 sm:mt-3 sm:px-6 md:mt-4 lg:mt-5 lg:px-8 xl:mt-10">
    <div class="sm:flex flex-col justify-center items-center text-center">
      ...
      <p class="mt-5 text-base text-gray-500 sm:mt-8 sm:text-lg sm:max-w-xl sm:mx-auto md:text-xl dark:text-gray-100">
      ...
      <div class="mt-8 sm:flex sm:justify-center lg:justify-start w-full max-w-lg space-x-4">
        ...
        <router-link to="/info" class="w-full transition-colors focus:outline-none text-white bg-bee hover:bg-yellow-400 focus:ring-4 focus:ring-yellow-200 font-medium rounded-lg text-lg px-6 py-4 mr-2 mb-2 dark:focus:ring-yellow-500">Informazioni dettagliate</router-link>
        <router-link to="/grafici" class="w-full transition-colors focus:outline-none text-white bg-bee hover:bg-yellow-400 focus:ring-4 focus:ring-yellow-200 font-medium rounded-lg text-lg px-6 py-4 mr-2 mb-2 dark:focus:ring-yellow-500">Graficazione dati</router-link>
      </div>
    </div>
