...
<script>
    ...
    const classe = [{
        "img" : "./static/images/photoOBT/Matteo_de_Privitellio.png",
        "nome" : "Matteo de Privitellio",
        "descrizione" : "Designer",
        "email" : "mailto:matteo.deprivitellio@isisbem.it",
        "github" : "#"
        "instageam" : "https://www.instagram.com/matteo28friz/",
    },
]
            ...
            <div class="sm:mx-auto grid grid-cols-1 gap-x-20 gap-y-12 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-2">
                ...
                <div class="px-12 py-8 transition-colors duration-300 transform border cursor-pointer rounded-xl border-neutral-400 hover:shadow-lg group">
                    <div class="flex flex-col sm:-mx-4 sm:flex-row">
                        <img class="mx-auto mt-2 flex-shrink-0 object-cover w-24 h-24 rounded-full sm:mx-4 ring-4 ring-gray-300 group-hover:ring-amber-500" src="./static/images/photoOBT/Matteo_de_Privitellio.png" alt="">
                ...
                <div class="px-12 py-8 transition-colors duration-300 transform border cursor-pointer rounded-xl border-neutral-400 hover:shadow-lg group">
                    <div class="flex flex-col sm:-mx-4 sm:flex-row">
                        <img class="mx-auto mt-2 flex-shrink-0 object-cover w-24 h-24 rounded-full sm:mx-4 ring-4 ring-gray-300 group-hover:ring-amber-500" src="./static/images/photoOBT/Matteo_Diblas.png" alt="">
                        <div class="mx-auto mt-4 sm:mx-4 sm:mt-0">
                ...
                <div class="px-12 py-8 transition-colors duration-300 transform border cursor-pointer rounded-xl border-neutral-400 hover:shadow-lg group">
                    <div class="flex flex-col sm:-mx-4 sm:flex-row">
                        <img class="mx-auto mt-2 flex-shrink-0 object-cover w-24 h-24 rounded-full sm:mx-4 ring-4 ring-gray-300 group-hover:ring-amber-500" src="./static/images/photoOBT/Matteo_Hajric.png" alt="">
                        <div class="mx-auto mt-4 sm:mx-4 sm:mt-0">
                ...
                <div class="px-12 py-8 transition-colors duration-300 transform border cursor-pointer rounded-xl border-neutral-400 hover:shadow-lg group">
                    <div class="flex flex-col sm:-mx-4 sm:flex-row">
                        <img class="mx-auto mt-2 flex-shrink-0 object-cover w-24 h-24 rounded-full sm:mx-4 ring-4 ring-gray-300 group-hover:ring-amber-500" src="./static/images/photoOBT/Domenico_Iervolino.png" alt="">
                        <div class="mx-auto mt-4 sm:mx-4 sm:mt-0">
                            <h1 class="text-center text-xl font-semibold text-gray-700 md:text-2xl -hover:text-white">Domenico Iervolino</h1>
                            <p class="mt-2 text-gray-500">Software Engineer</p>
                            <div class="mx-auto flex mt-4 sm:-mx-2">
                                <a target="_blank" href="mailto:matteo.diblas@isisbem.it" class="mx-2 text-gray-600  hover:text-gray-500 -300 group-hover:text-black" aria-label="Reddit">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                <div class="px-12 py-8 transition-colors duration-300 transform border cursor-pointer rounded-xl border-neutral-400 hover:shadow-lg group">
                    <div class="flex flex-col sm:-mx-4 sm:flex-row">
                        <img class="mx-auto mt-2 flex-shrink-0 object-cover w-24 h-24 rounded-full sm:mx-4 ring-4 ring-gray-300 group-hover:ring-amber-500" src="./static/images/photoOBT/Antonio_Iorio.png" alt="">
                        <div class="mx-auto mt-4 sm:mx-4 sm:mt-0">
                            <h1 class="text-center text-xl font-semibold text-gray-700 md:text-2xl -hover:text-white">Antonio Iorio</h1>
                            <p class="mt-2 text-gray-500">Web developer senior</p>
                            <div class="mx-auto flex mt-4 sm:-mx-2">
                                <a target="_blank" href="mailto:matteo.diblas@isisbem.it" class="mx-2 text-gray-600  hover:text-gray-500 -300 group-hover:text-black" aria-label="Reddit">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
