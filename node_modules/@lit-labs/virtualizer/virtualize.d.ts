...
export declare type RenderItemFunction<T = unknown> = (item: T, index: number) => TemplateResult;
...
export declare const virtualize: <T>(config?: VirtualizeDirectiveConfig<T> | undefined) => DirectiveResult<typeof VirtualizeDirective>;
