...
export declare type PixelSize = `${'0' | `${number}px`}`;
declare type GapValue = PixelSize;
declare type TwoGapValues = `${GapValue} ${GapValue}`;
export declare type GapSpec = GapValue | TwoGapValues;
export declare type AutoGapSpec = PixelSize | `${PixelSize} ${PixelSize}` | `auto ${PixelSize}` | `${PixelSize} auto`;
declare type PaddingValue = PixelSize | 'match-gap';
declare type TwoPaddingValues = `${PaddingValue} ${PaddingValue}`;
declare type ThreePaddingValues = `${TwoPaddingValues} ${PaddingValue}`;
declare type FourPaddingValues = `${ThreePaddingValues} ${PaddingValue}`;
declare type PaddingSpec = PaddingValue | TwoPaddingValues | ThreePaddingValues | FourPaddingValues;
declare type PixelDimensions = {
    width: PixelSize;
    height: PixelSize;
};
