...
export declare type margin = 'marginTop' | 'marginRight' | 'marginBottom' | 'marginLeft';
...
export declare type offsetAxis = 'xOffset' | 'yOffset';
...
export declare type LayoutHostMessage = StateChangedMessage | UnpinnedMessage | VisibilityChangedMessage;
export declare type LayoutHostSink = (message: LayoutHostMessage) => void;
export declare type ChildPositions = Map<number, Positions>;
export declare type ChildMeasurements = {
    [key: number]: ItemBox;
};
export declare type MeasureChildFunction = <T>(element: Element, item: T) => ItemBox;
export interface PinOptions {
    index: number;
    block?: ScrollLogicalPosition;
}
export declare type LayoutConstructor = new (sink: LayoutHostSink, config?: object) => Layout;
...
export declare type LayoutConfigValue = LayoutSpecifier | BaseLayoutConfig;
