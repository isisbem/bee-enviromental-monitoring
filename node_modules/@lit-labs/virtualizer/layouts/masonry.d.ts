...
declare type GetAspectRatio = (item: unknown) => number;
export interface MasonryLayoutConfig extends Omit<GridBaseLayoutConfig, 'flex' | 'itemSize'> {
    flex: boolean;
    itemSize: PixelSize;
    getAspectRatio: GetAspectRatio;
}
declare type MasonryLayoutSpecifier = MasonryLayoutConfig & {
    type: new (hostSink: LayoutHostSink, config?: MasonryLayoutConfig) => MasonryLayout;
};
declare type MasonryLayoutSpecifierFactory = (config?: MasonryLayoutConfig) => MasonryLayoutSpecifier;
