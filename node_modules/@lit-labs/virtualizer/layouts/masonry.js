...
export class MasonryLayout extends GridBaseLayout {
    ...
    _getActiveItems() {
        ...
        if (rolumns === 0 || this._rangeMap.size === 0) {
            ...
            const minRange = (_a = this._rangeMap.get(this._getRangeMapKey(min, MIN))) !== null && _a !== void 0 ? _a : [
                0, 0,
            ];
            const maxRange = (_b = this._rangeMap.get(this._getRangeMapKey(max, MAX))) !== null && _b !== void 0 ? _b : [
                maxIdx,
                maxIdx,
            ];
