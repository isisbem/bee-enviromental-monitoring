...
import { SizeGapPaddingBaseLayout, } from './shared/SizeGapPaddingBaseLayout.js';
...
export class FlexWrapLayout extends SizeGapPaddingBaseLayout {
    constructor() {
        ...
        this._chunks = [];
        this._chunkSizeCache = new SizeCache();
        this._rolumnSizeCache = new SizeCache();
        this._rolumnLengthCache = new SizeCache({ roundAverageSize: false });
    ...
    _getChunk(idx) {
        return (this._chunks[Math.floor(Number(idx) / this._chunkLength)] ||
            this._newChunk());
    }
    ...
    _layOutChunk(startIdx, endIdx /*, reverse=false*/) {
    ...
    _updateLayout() {
        if ( /*this._rolumnStartIdx === undefined ||*/this._viewDim2 === 0)
            return;
        this._chunkLength = Math.ceil((2 * (this._viewDim1 * this._viewDim2)) /
