...
import { Positions, Size, Margins, ScrollDirection, ChildMeasurements, BaseLayoutConfig } from './shared/Layout.js';
declare type ItemBounds = {
    pos: number;
    size: number;
};
declare type FlowLayoutConstructor = {
    prototype: FlowLayout;
    new (config?: BaseLayoutConfig): FlowLayout;
};
declare type FlowLayoutSpecifier = BaseLayoutConfig & {
    type: FlowLayoutConstructor;
};
declare type FlowLayoutSpecifierFactory = (config?: BaseLayoutConfig) => FlowLayoutSpecifier;
