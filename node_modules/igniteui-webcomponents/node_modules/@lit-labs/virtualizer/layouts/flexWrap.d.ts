...
import { ChildMeasurements, ItemBox, MeasureChildFunction, Positions, Size } from './shared/Layout.js';
interface FlexWrapLayoutConfig extends SizeGapPaddingBaseLayoutConfig {
    gap?: GapSpec;
}
declare type FlexWrapLayoutSpecifier = FlexWrapLayoutConfig & {
    type: new (config?: FlexWrapLayoutConfig) => FlexWrapLayout;
};
declare type FlexWrapLayoutSpecifierFactory = (config?: FlexWrapLayoutConfig) => FlexWrapLayoutSpecifier;
