 ...
 */
import { ItemBox, LayoutConfigValue, ChildMeasurements, MeasureChildFunction } from './layouts/shared/Layout.js';
...
export declare class Virtualizer {
    ...
    updateLayoutConfig(layoutConfig: LayoutConfigValue): boolean;
    private _initLayout;
